...
const whoami =  "models/pculturalModel: ";
...
const pculturalSch = new Schema({
    ...
    publico:      { type: String, required: false },
    ...
    fe_label:     { type: String, required: false },
...
pculturalSch.pre('save', function (next) {
    return next();
});
 ...
 */
const Record = mongoose.model('Pcultural', pculturalSch, 'pculturales');
