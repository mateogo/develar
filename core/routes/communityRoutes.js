...
const service = require('../models/communityModel.js');

const userservice = require('../services/usercommunityService');

const whoami =  "Router:routes/communityRoutes: ";
...
router.get('/fetchusers', function (req, res) {
    userservice.findByQuery(req.query, function(err) {
        res.status(400).json(err);
