/**
 * Audit Entregas routes
 * Hace búsquedas para auditar vinculos familiares y domicilios
 */

var express = require('express');
var router = express.Router();
var service = require('../models/auditentregasModel');

const whoami =  "Router:routes/autidentregasModel: ";
 ...
 * auditentrega
 */
router.get('/auditperson/:person', function (req, res) {
    console.log('process AUDIT PERSON ROUTE');
    service.auditEntregaByPerson(req.params.person, function(err) {
        res.status(400).json(err);
