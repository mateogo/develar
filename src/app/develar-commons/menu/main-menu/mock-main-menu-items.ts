...
export const SALUD_ITEMS: MainMenuItem[] = [
  {
...

  {
    ...
    sub: [
      ...
      {
        title: 'Tablero llamados',
        routing: '/salud/gestion/tablerollamados',
        rolesOut: ['ivr:operator']
      },
      {
...

  {
    ...
    sub: [
      ...
      },
      {
        ...
        routing: '/dsocial/gestion/observaciones'
      },
    ],
    routing: '',
    externalLink: '',
...
export const INDUSTRIAS_ITEMS: MainMenuItem[] = [
...

  {
    ...
    sub: [
      ...
      {
        title: 'Tablero censos',
        routing: '/develar/censos/censoempresarial',
      }
    ],
    routing: '',
    externalLink: '',
