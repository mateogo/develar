...
@Component({
  selector: 'app-vinculos-agregar-view',
  templateUrl: './vinculos-agregar-view.component.html',
  styleUrls: ['./vinculos-agregar-view.component.scss'],
})
export class VinculosAgregarViewComponent implements OnInit {
