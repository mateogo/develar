...
const UPDATE = 'update';
@Component({
  selector: 'personas-contactdata-base',
  templateUrl: './personas-contactdata-base.component.html',
  styleUrls: ['./personas-contactdata-base.component.scss']
})
export class PersonasContactdataBaseComponent implements OnInit {
