...
import { PersonContactData, UpdateItemListEvent, UpdateContactEvent } from '../../../../entities/person/person';
const CORE = 'core';
...
const UPDATE = 'update';
@Component({
  selector: 'personas-contactdata-panel',
  templateUrl: './personas-contactdata-panel.component.html',
  styleUrls: ['./personas-contactdata-panel.component.scss']
})
export class PersonasContactdataPanelComponent implements OnInit {
