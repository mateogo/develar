...
@Component({
  selector: 'remitoalmacen-entrega',
  templateUrl: './remitoalmacen-entrega.component.html',
  styleUrls: ['./remitoalmacen-entrega.component.scss']
})
export class RemitoalmacenEntregaComponent implements OnInit {
