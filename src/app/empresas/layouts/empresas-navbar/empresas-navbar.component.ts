...
@Component({
  selector: 'empresas-navbar',
  templateUrl: './empresas-navbar.component.html',
  styleUrls: ['./empresas-navbar.component.scss']
})
export class EmpresasNavbarComponent implements OnInit {
  @Input() title: string;
