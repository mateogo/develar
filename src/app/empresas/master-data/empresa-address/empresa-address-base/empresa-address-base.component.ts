...
@Component({
  selector: 'empresa-address-base',
  templateUrl: './empresa-address-base.component.html',
  styleUrls: ['./empresa-address-base.component.scss']
})
export class EmpresaAddressBaseComponent implements OnInit {
	@Input() token: Address;
