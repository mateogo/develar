...
@Component({
  selector: 'empresa-contactdata-panel',
  templateUrl: './empresa-contactdata-panel.component.html',
  styleUrls: ['./empresa-contactdata-panel.component.scss']
})
export class EmpresaContactdataPanelComponent implements OnInit {
