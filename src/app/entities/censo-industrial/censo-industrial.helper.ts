...
function fetchAction(val, type) {
  ...
  return nomencladorList.find(
    (t) => t.val === val && t.isSeccion === isSeccion && t.isTitulo === isTitulo
  );
}
...
const actionOptList: Array<any> = [
  {
    val: 'censoindustrias',
    type: 'Censo Industrias',
    label: 'Censo Industrias',
  },
...
const sectorOptList = [
  ...
  {
    val: 'dginspeccion',
    label: 'Dirección General de Inspección',
    slug: 'Inspección',
  },
];
...
const posCadenaProductivaOptList = [
  ...
  {
    val: 'primario',
    label: 'Extracción; cultivo, criadero',
    slug: 'Extracción; cultivo, criadero',
  },
  {
    val: 'intermedio',
    label: 'Ind Bienes intermedios',
    slug: 'Ind Bienes intermedios',
  },
  {
    val: 'insumos',
    label: 'Ind Insumos indus/comerciales',
    slug: 'Ind Insumos indus/comerciales',
  },
  {
    val: 'mayorista',
    label: 'Distribuidor mayorista',
    slug: 'Distribuidor mayorista',
  },
  {
    val: 'consmasivo',
    label: 'Ind Bienes consumo masivo',
    slug: 'Ind Bienes consumo masivo',
  },
  { val: 'retail', label: 'Comercio - Retail', slug: 'Comercio - Retail' },
  {
    val: 'transporte',
    label: 'Transporte-logística',
    slug: 'Transporte-logística',
  },
...
const profesionesOptList: Array<any> = [
  ...
  {
    val: 'microemprendim',
    label: 'Microemprendedor/a',
    slug: 'Microemprendedor/a',
  },
...
const competenciaTypeOptList: Array<any> = [
  ...
  {
    val: 'comercializacion',
    label: 'Estructura de comercialización',
    slug: 'Estructura de comercialización',
  },
  {
    val: 'escalaproductiva',
    label: 'Escala productiva',
    slug: 'Escala productiva',
  },
...
export class CensoIndustriasHelper {
  ...
  static getRubroOptList(seccion) {
    ...
    if (token) {
      list = nomencladorList.filter(
        (t) =>
          t.seccion === token.seccion && t.isTitulo === 1 && t.isSeccion === 0
      );
      list = list || [];
    }
  ...
  static getCodigoOptList(rubro) {
    ...
    list = nomencladorList.filter(
      (t) => t.titulo === rubro && t.isTitulo === 0 && t.isSeccion === 0
    );
    list = list || [];
