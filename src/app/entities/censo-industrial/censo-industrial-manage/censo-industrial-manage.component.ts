...
@Component({
  selector: 'censo-industrial-manage',
  templateUrl: './censo-industrial-manage.component.html',
  styleUrls: ['./censo-industrial-manage.component.scss']
})
export class CensoIndustrialManageComponent implements OnInit {
