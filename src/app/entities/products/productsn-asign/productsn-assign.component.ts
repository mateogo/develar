...
@Component({
  selector: 'productsn-assign',
  templateUrl: './productsn-assign.component.html',
  styleUrls: ['./productsn-assign.component.scss']
})
export class ProductsnAssignComponent implements OnInit {
