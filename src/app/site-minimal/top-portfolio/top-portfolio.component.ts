...
@Component({
  selector: 'top-portfolio',
  templateUrl: './top-portfolio.component.html',
  styleUrls: ['./top-portfolio.component.scss'],
  animations: [
    trigger('heroState', [
...
export class TopPortfolioComponent implements OnInit {
