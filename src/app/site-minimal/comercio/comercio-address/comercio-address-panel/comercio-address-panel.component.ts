...
@Component({
  selector: 'comercio-address-panel',
  templateUrl: './comercio-address-panel.component.html',
  styleUrls: ['./comercio-address-panel.component.scss']
})
export class ComercioAddressPanelComponent implements OnInit {
