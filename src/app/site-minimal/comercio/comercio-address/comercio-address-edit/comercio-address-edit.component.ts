...
@Component({
  selector: 'comercio-address-edit',
  templateUrl: './comercio-address-edit.component.html',
  styleUrls: ['./comercio-address-edit.component.scss']
})
export class ComercioAddressEditComponent implements OnInit {
	@Input() token: Address;
