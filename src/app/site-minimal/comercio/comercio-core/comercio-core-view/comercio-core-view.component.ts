...
@Component({
  selector: 'comercio-core-view',
  templateUrl: './comercio-core-view.component.html',
  styleUrls: ['./comercio-core-view.component.scss']
})
export class ComercioCoreViewComponent implements OnInit {
	@Input() person: Person;
	public pname;
  public familyName;
	public pdoc;
