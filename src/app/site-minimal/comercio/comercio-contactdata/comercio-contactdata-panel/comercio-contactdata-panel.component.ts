...
@Component({
  selector: 'comercio-contactdata-panel',
  templateUrl: './comercio-contactdata-panel.component.html',
  styleUrls: ['./comercio-contactdata-panel.component.scss']
})
export class ComercioContactdataPanelComponent implements OnInit {
