...
@Component({
  selector: 'comercio-contactdata-base',
  templateUrl: './comercio-contactdata-base.component.html',
  styleUrls: ['./comercio-contactdata-base.component.scss']
})
export class ComercioContactdataBaseComponent implements OnInit {
