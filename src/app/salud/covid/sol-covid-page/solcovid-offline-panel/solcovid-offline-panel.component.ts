...
@Component({
  selector: 'solcovid-offline-panel',
  templateUrl: './solcovid-offline-panel.component.html',
  styleUrls: ['./solcovid-offline-panel.component.scss']
})
export class SolcovidOfflinePanelComponent implements OnInit {
  ...
  private eventToken: UpdateAsistenciaEvent;
  ...
  editTokent(){
    ...
    this.emitEvent(this.eventToken)
